...
Not necessarily. You can use any of the public RPC nodes on either [mainnet](https://docs.filecoin.io/networks/mainnet/details/) or the \[Calibration testnet]\(/networks/calibration/details/
